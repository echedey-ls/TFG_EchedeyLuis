...
\usepackage[htt]{hyphenat} % hyphenation for typewriter text
...
% custom margins for toc page numbers
\makeatletter
\renewcommand{\l@section}{\@dottedtocline{1}{1.5em}{2.6em}}
\renewcommand{\l@subsection}{\@dottedtocline{2}{4.0em}{3.6em}}
\renewcommand{\l@subsubsection}{\@dottedtocline{3}{7.4em}{4.6em}}
\makeatother
...
% Issue
\newcommand{\issue}[2][\pvlibRepoLink]{\textit{Issue:} \href{#1/issues/#2}{\texttt{\##2}}}
% Pull Request
\newcommand{\pr}[2][\pvlibRepoLink]{\textit{Pull Request:} \href{#1/pull/#2}{\texttt{\##2}}}
% Discussion
\newcommand{\discussion}[2][\pvlibRepoLink]{\textit{Discussion:} \href{#1/discussions/}{\texttt{\##2}}}
...
% Shortcut for writing pvlib-python
\newcommand{\pvlibpy}{\textit{pvlib-python}}

% Environment for custom indentation
