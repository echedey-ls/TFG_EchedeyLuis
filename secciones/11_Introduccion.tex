...
\begin{itemize}
    ...
    \item[•] En \fullref{chp:pvlib}, se presentan las características de la biblioteca \textit{pvlib python}.
    ...
    \item[•] En \fullref{chp:resultados}, se resume el resultado de las propuestas realizadas
