...
Adicionalmente, se espera un impacto positivo, consecuencia natural y deseable del presente proyecto, que se describen en la \fullref{sct:resultados:impacto}.
...
\begin{itemize}
    ...
    \item \fullref{chp:conclusiones}: resume y hace una valoración global de los resultados obtenidos.
